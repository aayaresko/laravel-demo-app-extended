...
@if ($model->id)
    <?php $route = ['backend.blog-post.update', $model->id] ?>
@else
    <?php $route = 'backend.blog-post.store' ?>
@endif
...
<div class="row">
    <div class="col-md-4">
        ...
        <div class="form-group">
            {{ Form::label('author_id', trans_choice('content.author_title', 2), ['class' => 'control-label']) }}
