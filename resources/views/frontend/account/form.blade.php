{{ Form::open(['method' => 'post', 'route' => 'frontend.account.update', 'class' => 'form-horizontal', 'role' => 'form', 'files' => true]) }}
<div class="row">
    <div class="col-md-2">
    ...
    <div class="col-md-2 col-md-offset-1">
        <div class="form-group">
            ...
            {{ Form::text('first_name', $profile->first_name, ['placeholder' => trans('account.first_name_placeholder'), 'class' => 'form-control']) }}
        </div>
        <div class="form-group">
            {{ Form::label('last_name', trans('account.last_name_label'), ['class' => 'control-label']) }}
            {{ Form::text('last_name', $profile->last_name, ['placeholder' => trans('account.last_name_placeholder'), 'class' => 'form-control']) }}
        </div>
    </div>
    <div class="col-md-2 col-md-offset-1">
        <div class="form-group">
...
<div class="row">
    <div class="col-md-12">
        <div class="form-group">
            ...
            <a href="{{ route('frontend.subscriptions.edit') }}" class="btn btn-success">@lang('subscription.update')</a>
        </div>
    </div>
</div>
{{ Form::close() }}