@if (count($images))
    <div id="catalog-product-images-carousel" class="carousel slide">
        ...
        <a class="left carousel-control" href="#catalog-product-images-carousel" role="button" data-slide="prev">
            <span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span>
            <span class="sr-only">@lang('content.previous')</span>
        </a>
        <a class="right carousel-control" href="#catalog-product-images-carousel" role="button" data-slide="next">
